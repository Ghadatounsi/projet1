...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="http://localhost/projet1/dashboard/Gestion_Formation/ajouter_formation.php">Ajouter De Formation</a>
            <a class="collapse-item" href="http://localhost/projet1/dashboard/Gestion_Formation/liste_formation.php">Liste Des Formations</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="http://localhost/projet1/dashboard/Gestion_Formateur/ajouter_formateur.php">Ajouter de Formateur</a>
            <a class="collapse-item" href="http://localhost/projet1/dashboard/Gestion_Formateur/liste_formateur.php">Liste de Formateur</a>
