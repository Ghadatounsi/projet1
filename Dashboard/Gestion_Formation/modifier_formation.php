...
$formation = $formationModel->getFormationById($id);
...
if($formation) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $controller->updateFormation($id, $titre, $description, $objectif, $programme, $duree, $prix, $date);

        // Rediriger vers la liste des formations après la mise à jour
        header("Location: liste_formation.php?session_id=" . $session_id);
        exit();
    }
} else {
