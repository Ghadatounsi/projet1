					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Services</h1>
								<p class="mb-4">Découvrez nos services sur mesure conçus pour répondre à vos besoins spécifiques. Nous vous proposons une gamme variée de solutions adaptées à vos attentes</p>
